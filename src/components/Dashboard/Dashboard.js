...
export default function Dashboard() {
    ...
    return (
        ...
        <div class="container" style={{paddingBottom:'100px'}}>
                <div class="row mb-2">
                    <nav aria-label="breadcrumb" class="mb-5" style={{ marginTop: '15px', backgroundColor: '#CBC0D3 ' }}>
                        <ol class="breadcrumb">
                ...
                <div class="row mb-3" >
                    <div class="col-md-2 mb-3 " tyle={{ marginLeft: '60px' }}></div>
                    ...
                    <div class="row text-center">
                        <div class="col-xs-12 col-sm-6 col-xl-6 mb-3">
                            <Table striped bordered hover >
                                <thead style={{ backgroundColor: '#CBC0D3' }}>
                                    <tr>
                                        <th colSpan={3}>
                                            Clients/Produits</th>
                                    </tr>
