...
export default function ConsulterImpression() {
    const { id } = useParams();
                ...
                <div className="row mb-1">
                    <nav aria-label="breadcrumb" className="mb-5" style={{ marginTop: '15px', backgroundColor: '#c9def7be ' }}>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item"><a href="/CommandeImpression">Liste des Commandes en Cours d'Impression</a></li>
                                        ...
                                        <div className="card" style={{ backgroundColor: '#c9def7be ' }}>
                                            <div className="card-body">
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-4">
                                                        <label style={{ fontFamily: 'bold', color: 'black', fontSize: '18px' }}>Date d'impression:<b>{item.reference}</b></label>|<b>{item.dateimpression}</b>
                                                    </div>
                                                    <div className="col-sm-4">
